...
assert.match(data, /value: "5 – 7"/);
assert.match(data, /value: "≥ 92"/);
assert.match(data, /unit: "BU", value: "≥ 730"/);
assert.match(data, /Độ ẩm bã sấy/);
assert.match(data, /Dried-pulp moisture/);
assert.match(data, /干渣水分/);
