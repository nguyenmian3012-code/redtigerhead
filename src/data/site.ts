...
export const copy = {
  vi: {
    ...
    "market.notice": "* Đây là giá tham khảo, giá thực tế không vượt quá ±5%.",
  ...
  en: {
    ...
    "market.notice": "* Reference prices only; actual prices are expected within ±5%.",
    "market.starch": "Starch EXW",
    "market.root": "Factory raw material",
    "market.residue": "Cassava residue EXW",
    ...
    "aboutPage.lead": "Focused on stable quality, practical supply capability and sustainable development.",
  ...
  zh: {
    ...
    "about.summary": "Binh Minh 为食品和工业领域生产高品质木薯淀粉。我们专注于稳定品质、国际标准及长期客户合作。",
    ...
    "process.packing": "包装",
    "market.title": "参考价格走势",
    "market.notice": "* 仅供参考；实际价格预计在 ±5% 范围内。",
    "market.starch": "淀粉出厂价",
    "market.root": "工厂原料价",
